    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[calc(100vh-120px)]">
        ...
        <div className="border rounded-lg p-4 flex flex-col">
          <div className="text-sm font-medium mb-2 text-muted-foreground">Markdown</div>
          <Textarea
            value={markdown}
        ...
        <div className="border rounded-lg p-4 flex flex-col">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="sm" onClick={handleExport} disabled={!isLibraryLoaded || isExporting}>
          ...
          <div ref={previewRef} className="flex-1 overflow-auto prose prose-sm max-w-none dark:prose-invert p-3">
